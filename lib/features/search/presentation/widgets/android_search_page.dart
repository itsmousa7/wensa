// The original search_page.dart — unchanged, just renamed.
...
class AndroidSearchPage extends ConsumerStatefulWidget {
  const AndroidSearchPage({super.key});

  @override
  ConsumerState<AndroidSearchPage> createState() => _AndroidSearchPageState();
}

class _AndroidSearchPageState extends ConsumerState<AndroidSearchPage> {
