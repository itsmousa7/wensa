...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,placeId,titleAr,titleEn,descriptionAr,descriptionEn,coverImageUrl,logoUrl,startDate,endDate,ticketPrice,ticketUrl,city,cityAr,latitude,longitude,isFeatured,isVerified,viewCount,savesCount,reviewsCount,sharesCount,checkinsCount,bookingsCount,hotnessScore,createdAt,updatedAt]);

@override
String toString() {
  return 'EventModel(id: $id, placeId: $placeId, titleAr: $titleAr, titleEn: $titleEn, descriptionAr: $descriptionAr, descriptionEn: $descriptionEn, coverImageUrl: $coverImageUrl, logoUrl: $logoUrl, startDate: $startDate, endDate: $endDate, ticketPrice: $ticketPrice, ticketUrl: $ticketUrl, city: $city, cityAr: $cityAr, latitude: $latitude, longitude: $longitude, isFeatured: $isFeatured, isVerified: $isVerified, viewCount: $viewCount, savesCount: $savesCount, reviewsCount: $reviewsCount, sharesCount: $sharesCount, checkinsCount: $checkinsCount, bookingsCount: $bookingsCount, hotnessScore: $hotnessScore, createdAt: $createdAt, updatedAt: $updatedAt)';
}
