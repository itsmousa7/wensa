...
mixin _$EventModel {
 ...
 String get id; String? get placeId; String get titleAr; String get titleEn; String? get descriptionAr; String? get descriptionEn; String? get coverImageUrl; String? get logoUrl; String get startDate; String? get endDate; double? get ticketPrice; String? get ticketUrl; String? get city; double? get latitude; double? get longitude; bool get isFeatured; bool get isVerified; int get viewCount; int get savesCount; int get reviewsCount; int get sharesCount; int get checkinsCount; int get bookingsCount; double get hotnessScore; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,placeId,titleAr,titleEn,descriptionAr,descriptionEn,coverImageUrl,logoUrl,startDate,endDate,ticketPrice,ticketUrl,city,latitude,longitude,isFeatured,isVerified,viewCount,savesCount,reviewsCount,sharesCount,checkinsCount,bookingsCount,hotnessScore,createdAt,updatedAt]);
...
class _EventModel implements EventModel {
  const _EventModel({this.id = '', this.placeId, this.titleAr = '', this.titleEn = '', this.descriptionAr, this.descriptionEn, this.coverImageUrl, this.logoUrl, this.startDate = '', this.endDate, this.ticketPrice, this.ticketUrl, this.city, this.latitude, this.longitude, this.isFeatured = false, this.isVerified = false, this.viewCount = 0, this.savesCount = 0, this.reviewsCount = 0, this.sharesCount = 0, this.checkinsCount = 0, this.bookingsCount = 0, this.hotnessScore = 0.0, this.createdAt, this.updatedAt});
