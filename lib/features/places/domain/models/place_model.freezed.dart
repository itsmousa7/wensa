...
mixin _$PlaceModel {
 ...
 String get id; String? get merchantId; String get nameAr; String get nameEn; String? get descriptionAr; String? get descriptionEn; String? get categoryId; String get city; String? get cityAr; String? get area; String? get areaAr; String? get addressText; double? get latitude; double? get longitude; String? get coverImageUrl; String? get logoUrl; List<String> get additionalImages;// ← ADD THIS
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,merchantId,nameAr,nameEn,descriptionAr,descriptionEn,categoryId,city,cityAr,area,areaAr,addressText,latitude,longitude,coverImageUrl,logoUrl,const DeepCollectionEquality().hash(additionalImages),isNew,isTrending,isVerified,isFeatured,const DeepCollectionEquality().hash(openingHours),phone,instagramUrl,websiteUrl,viewCount,savesCount,reviewsCount,sharesCount,checkinsCount,hotnessScore,createdAt,updatedAt,bookingCategory]);

@override
String toString() {
  return 'PlaceModel(id: $id, merchantId: $merchantId, nameAr: $nameAr, nameEn: $nameEn, descriptionAr: $descriptionAr, descriptionEn: $descriptionEn, categoryId: $categoryId, city: $city, cityAr: $cityAr, area: $area, areaAr: $areaAr, addressText: $addressText, latitude: $latitude, longitude: $longitude, coverImageUrl: $coverImageUrl, logoUrl: $logoUrl, additionalImages: $additionalImages, isNew: $isNew, isTrending: $isTrending, isVerified: $isVerified, isFeatured: $isFeatured, openingHours: $openingHours, phone: $phone, instagramUrl: $instagramUrl, websiteUrl: $websiteUrl, viewCount: $viewCount, savesCount: $savesCount, reviewsCount: $reviewsCount, sharesCount: $sharesCount, checkinsCount: $checkinsCount, hotnessScore: $hotnessScore, createdAt: $createdAt, updatedAt: $updatedAt, bookingCategory: $bookingCategory)';
}
...
@useResult
$Res call({
 String id, String? merchantId, String nameAr, String nameEn, String? descriptionAr, String? descriptionEn, String? categoryId, String city, String? cityAr, String? area, String? areaAr, String? addressText, double? latitude, double? longitude, String? coverImageUrl, String? logoUrl, List<String> additionalImages, bool isNew, bool isTrending, bool isVerified, bool isFeatured, Map<String, dynamic>? openingHours, String? phone, String? instagramUrl, String? websiteUrl, int viewCount, int savesCount, int reviewsCount, int sharesCount, int checkinsCount, double hotnessScore, String? createdAt, String? updatedAt, String? bookingCategory
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String? merchantId,  String nameAr,  String nameEn,  String? descriptionAr,  String? descriptionEn,  String? categoryId,  String city,  String? cityAr,  String? area,  String? areaAr,  String? addressText,  double? latitude,  double? longitude,  String? coverImageUrl,  String? logoUrl,  List<String> additionalImages,  bool isNew,  bool isTrending,  bool isVerified,  bool isFeatured,  Map<String, dynamic>? openingHours,  String? phone,  String? instagramUrl,  String? websiteUrl,  int viewCount,  int savesCount,  int reviewsCount,  int sharesCount,  int checkinsCount,  double hotnessScore,  String? createdAt,  String? updatedAt,  String? bookingCategory)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaceModel() when $default != null:
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String? merchantId,  String nameAr,  String nameEn,  String? descriptionAr,  String? descriptionEn,  String? categoryId,  String city,  String? cityAr,  String? area,  String? areaAr,  String? addressText,  double? latitude,  double? longitude,  String? coverImageUrl,  String? logoUrl,  List<String> additionalImages,  bool isNew,  bool isTrending,  bool isVerified,  bool isFeatured,  Map<String, dynamic>? openingHours,  String? phone,  String? instagramUrl,  String? websiteUrl,  int viewCount,  int savesCount,  int reviewsCount,  int sharesCount,  int checkinsCount,  double hotnessScore,  String? createdAt,  String? updatedAt,  String? bookingCategory)  $default,) {final _that = this;
switch (_that) {
case _PlaceModel():
return $default(_that.id,_that.merchantId,_that.nameAr,_that.nameEn,_that.descriptionAr,_that.descriptionEn,_that.categoryId,_that.city,_that.cityAr,_that.area,_that.areaAr,_that.addressText,_that.latitude,_that.longitude,_that.coverImageUrl,_that.logoUrl,_that.additionalImages,_that.isNew,_that.isTrending,_that.isVerified,_that.isFeatured,_that.openingHours,_that.phone,_that.instagramUrl,_that.websiteUrl,_that.viewCount,_that.savesCount,_that.reviewsCount,_that.sharesCount,_that.checkinsCount,_that.hotnessScore,_that.createdAt,_that.updatedAt,_that.bookingCategory);case _:
  throw StateError('Unexpected subclass');
...
class _PlaceModel implements PlaceModel {
  const _PlaceModel({this.id = '', this.merchantId, this.nameAr = '', this.nameEn = '', this.descriptionAr, this.descriptionEn, this.categoryId, this.city = '', this.cityAr, this.area, this.areaAr, this.addressText, this.latitude, this.longitude, this.coverImageUrl, this.logoUrl, final  List<String> additionalImages = const <String>[], this.isNew = false, this.isTrending = false, this.isVerified = false, this.isFeatured = false, final  Map<String, dynamic>? openingHours, this.phone, this.instagramUrl, this.websiteUrl, this.viewCount = 0, this.savesCount = 0, this.reviewsCount = 0, this.sharesCount = 0, this.checkinsCount = 0, this.hotnessScore = 0.0, this.createdAt, this.updatedAt, this.bookingCategory}): _additionalImages = additionalImages,_openingHours = openingHours;
