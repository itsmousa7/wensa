...
mixin _$PlaceModel {
 ...
 String get id; String get nameAr; String get nameEn; String? get descriptionAr; String? get descriptionEn; String? get categoryId; String get city; String? get area; String? get addressText; double? get latitude; double? get longitude; String? get coverImageUrl; bool get isNew; bool get isTrending; bool get isVerified; bool get isFeatured;// opening_hours stored as raw Map since it's a flexible jsonb
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,nameAr,nameEn,descriptionAr,descriptionEn,categoryId,city,area,addressText,latitude,longitude,coverImageUrl,isNew,isTrending,isVerified,isFeatured,const DeepCollectionEquality().hash(openingHours),phone,instagramUrl,websiteUrl,viewCount,savesCount,reviewsCount,sharesCount,checkinsCount,hotnessScore,createdAt,updatedAt]);

@override
String toString() {
  return 'PlaceModel(id: $id, nameAr: $nameAr, nameEn: $nameEn, descriptionAr: $descriptionAr, descriptionEn: $descriptionEn, categoryId: $categoryId, city: $city, area: $area, addressText: $addressText, latitude: $latitude, longitude: $longitude, coverImageUrl: $coverImageUrl, isNew: $isNew, isTrending: $isTrending, isVerified: $isVerified, isFeatured: $isFeatured, openingHours: $openingHours, phone: $phone, instagramUrl: $instagramUrl, websiteUrl: $websiteUrl, viewCount: $viewCount, savesCount: $savesCount, reviewsCount: $reviewsCount, sharesCount: $sharesCount, checkinsCount: $checkinsCount, hotnessScore: $hotnessScore, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String nameAr, String nameEn, String? descriptionAr, String? descriptionEn, String? categoryId, String city, String? area, String? addressText, double? latitude, double? longitude, String? coverImageUrl, bool isNew, bool isTrending, bool isVerified, bool isFeatured, Map<String, dynamic>? openingHours, String? phone, String? instagramUrl, String? websiteUrl, int viewCount, int savesCount, int reviewsCount, int sharesCount, int checkinsCount, double hotnessScore, String? createdAt, String? updatedAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String nameAr,  String nameEn,  String? descriptionAr,  String? descriptionEn,  String? categoryId,  String city,  String? area,  String? addressText,  double? latitude,  double? longitude,  String? coverImageUrl,  bool isNew,  bool isTrending,  bool isVerified,  bool isFeatured,  Map<String, dynamic>? openingHours,  String? phone,  String? instagramUrl,  String? websiteUrl,  int viewCount,  int savesCount,  int reviewsCount,  int sharesCount,  int checkinsCount,  double hotnessScore,  String? createdAt,  String? updatedAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _PlaceModel() when $default != null:
return $default(_that.id,_that.nameAr,_that.nameEn,_that.descriptionAr,_that.descriptionEn,_that.categoryId,_that.city,_that.area,_that.addressText,_that.latitude,_that.longitude,_that.coverImageUrl,_that.isNew,_that.isTrending,_that.isVerified,_that.isFeatured,_that.openingHours,_that.phone,_that.instagramUrl,_that.websiteUrl,_that.viewCount,_that.savesCount,_that.reviewsCount,_that.sharesCount,_that.checkinsCount,_that.hotnessScore,_that.createdAt,_that.updatedAt);case _:
  return orElse();
...
class _PlaceModel implements PlaceModel {
  const _PlaceModel({this.id = '', this.nameAr = '', this.nameEn = '', this.descriptionAr, this.descriptionEn, this.categoryId, this.city = '', this.area, this.addressText, this.latitude, this.longitude, this.coverImageUrl, this.isNew = false, this.isTrending = false, this.isVerified = false, this.isFeatured = false, final  Map<String, dynamic>? openingHours, this.phone, this.instagramUrl, this.websiteUrl, this.viewCount = 0, this.savesCount = 0, this.reviewsCount = 0, this.sharesCount = 0, this.checkinsCount = 0, this.hotnessScore = 0.0, this.createdAt, this.updatedAt}): _openingHours = openingHours;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,nameAr,nameEn,descriptionAr,descriptionEn,categoryId,city,area,addressText,latitude,longitude,coverImageUrl,isNew,isTrending,isVerified,isFeatured,const DeepCollectionEquality().hash(_openingHours),phone,instagramUrl,websiteUrl,viewCount,savesCount,reviewsCount,sharesCount,checkinsCount,hotnessScore,createdAt,updatedAt]);
