...
class _PlaceModel implements PlaceModel {
  const _PlaceModel({this.id = '', this.nameAr = '', this.nameEn = '', this.descriptionAr, this.descriptionEn, this.categoryId, this.city = '', this.area, this.addressText, this.latitude, this.longitude, this.coverImageUrl, this.logoUrl, final  List<String> additionalImages = const <String>[], this.isNew = false, this.isTrending = false, this.isVerified = false, this.isFeatured = false, final  Map<String, dynamic>? openingHours, this.phone, this.instagramUrl, this.websiteUrl, this.viewCount = 0, this.savesCount = 0, this.reviewsCount = 0, this.sharesCount = 0, this.checkinsCount = 0, this.hotnessScore = 0.0, this.createdAt, this.updatedAt, this.bookingCategory}): _additionalImages = additionalImages,_openingHours = openingHours;
