...
mixin _$ReviewModel {
 ...
 String get id; String get placeId; String get userId; int get rating; String? get comment; String? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,placeId,userId,rating,comment,createdAt);

@override
String toString() {
  return 'ReviewModel(id: $id, placeId: $placeId, userId: $userId, rating: $rating, comment: $comment, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String placeId, String userId, int rating, String? comment, String? createdAt
});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@pragma('vm:prefer-inline') @override $Res call({Object? id = null,Object? placeId = null,Object? userId = null,Object? rating = null,Object? comment = freezed,Object? createdAt = freezed,}) {
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String placeId,  String userId,  int rating,  String? comment,  String? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.placeId,_that.userId,_that.rating,_that.comment,_that.createdAt);case _:
  return orElse();
...
@optionalTypeArgs TResult when<TResult extends Object?>(TResult Function( String id,  String placeId,  String userId,  int rating,  String? comment,  String? createdAt)  $default,) {final _that = this;
switch (_that) {
case _ReviewModel():
return $default(_that.id,_that.placeId,_that.userId,_that.rating,_that.comment,_that.createdAt);case _:
  throw StateError('Unexpected subclass');
...
@optionalTypeArgs TResult? whenOrNull<TResult extends Object?>(TResult? Function( String id,  String placeId,  String userId,  int rating,  String? comment,  String? createdAt)?  $default,) {final _that = this;
switch (_that) {
case _ReviewModel() when $default != null:
return $default(_that.id,_that.placeId,_that.userId,_that.rating,_that.comment,_that.createdAt);case _:
  return null;
...
class _ReviewModel implements ReviewModel {
  const _ReviewModel({this.id = '', this.placeId = '', this.userId = '', this.rating = 1, this.comment, this.createdAt});
...
/// Create a copy of ReviewModel
/// with the given fields replaced by the non-null parameter values.
@override @pragma('vm:prefer-inline') $Res call({Object? id = null,Object? placeId = null,Object? userId = null,Object? rating = null,Object? comment = freezed,Object? createdAt = freezed,}) {
