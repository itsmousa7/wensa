...
mixin _$Membership {
 ...
 String get id; String get userId; String get merchantId; String get placeId; String get planId; MembershipStatus get status; String get membershipType; String get startsAt; String get endsAt; int get amountIqd; String? get paymentId; String? get paymentStatus; PaymentMethod get paymentMethod; String? get waylCode; String get qrToken; bool get isFrozen; String? get createdAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hash(runtimeType,id,userId,merchantId,placeId,planId,status,membershipType,startsAt,endsAt,amountIqd,paymentId,paymentStatus,paymentMethod,waylCode,qrToken,isFrozen,createdAt);

@override
String toString() {
  return 'Membership(id: $id, userId: $userId, merchantId: $merchantId, placeId: $placeId, planId: $planId, status: $status, membershipType: $membershipType, startsAt: $startsAt, endsAt: $endsAt, amountIqd: $amountIqd, paymentId: $paymentId, paymentStatus: $paymentStatus, paymentMethod: $paymentMethod, waylCode: $waylCode, qrToken: $qrToken, isFrozen: $isFrozen, createdAt: $createdAt)';
}
...
@useResult
$Res call({
 String id, String userId, String merchantId, String placeId, String planId, MembershipStatus status, String membershipType, String startsAt, String endsAt, int amountIqd, String? paymentId, String? paymentStatus, PaymentMethod paymentMethod, String? waylCode, String qrToken, bool isFrozen, String? createdAt
});
...
@optionalTypeArgs TResult maybeWhen<TResult extends Object?>(TResult Function( String id,  String userId,  String merchantId,  String placeId,  String planId,  MembershipStatus status,  String membershipType,  String startsAt,  String endsAt,  int amountIqd,  String? paymentId,  String? paymentStatus,  PaymentMethod paymentMethod,  String? waylCode,  String qrToken,  bool isFrozen,  String? createdAt)?  $default,{required TResult orElse(),}) {final _that = this;
switch (_that) {
case _Membership() when $default != null:
return $default(_that.id,_that.userId,_that.merchantId,_that.placeId,_that.planId,_that.status,_that.membershipType,_that.startsAt,_that.endsAt,_that.amountIqd,_that.paymentId,_that.paymentStatus,_that.paymentMethod,_that.waylCode,_that.qrToken,_that.isFrozen,_that.createdAt);case _:
  return orElse();
...
class _Membership implements Membership {
  const _Membership({this.id = '', this.userId = '', this.merchantId = '', this.placeId = '', this.planId = '', this.status = MembershipStatus.pending, this.membershipType = '', this.startsAt = '', this.endsAt = '', this.amountIqd = 0, this.paymentId, this.paymentStatus, this.paymentMethod = PaymentMethod.wayl, this.waylCode, this.qrToken = '', this.isFrozen = false, this.createdAt});
