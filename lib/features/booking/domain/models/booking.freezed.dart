...
mixin _$Booking {
 ...
 String get id; String get userId; String get merchantId; String? get placeId; String? get eventId; BookingCategory get category; BookingStatus get status; String get startsAt; String get endsAt; int get amountIqd; String? get paymentId; String? get paymentStatus; PaymentMethod get paymentMethod; String? get waylCode; String get qrToken; String? get holdUntil; Map<String, dynamic> get categoryData; String? get groupId; String? get createdAt; String? get updatedAt;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,merchantId,placeId,eventId,category,status,startsAt,endsAt,amountIqd,paymentId,paymentStatus,paymentMethod,waylCode,qrToken,holdUntil,const DeepCollectionEquality().hash(categoryData),groupId,createdAt,updatedAt]);

@override
String toString() {
  return 'Booking(id: $id, userId: $userId, merchantId: $merchantId, placeId: $placeId, eventId: $eventId, category: $category, status: $status, startsAt: $startsAt, endsAt: $endsAt, amountIqd: $amountIqd, paymentId: $paymentId, paymentStatus: $paymentStatus, paymentMethod: $paymentMethod, waylCode: $waylCode, qrToken: $qrToken, holdUntil: $holdUntil, categoryData: $categoryData, groupId: $groupId, createdAt: $createdAt, updatedAt: $updatedAt)';
}
...
@useResult
$Res call({
 String id, String userId, String merchantId, String? placeId, String? eventId, BookingCategory category, BookingStatus status, String startsAt, String endsAt, int amountIqd, String? paymentId, String? paymentStatus, PaymentMethod paymentMethod, String? waylCode, String qrToken, String? holdUntil, Map<String, dynamic> categoryData, String? groupId, String? createdAt, String? updatedAt
});
...
as PaymentMethod,waylCode: freezed == waylCode ? _self.waylCode : waylCode // ignore: cast_nullable_to_non_nullable
...
class _Booking implements Booking {
  const _Booking({this.id = '', this.userId = '', this.merchantId = '', this.placeId, this.eventId, this.category = BookingCategory.hourly, this.status = BookingStatus.pending, this.startsAt = '', this.endsAt = '', this.amountIqd = 0, this.paymentId, this.paymentStatus, this.paymentMethod = PaymentMethod.wayl, this.waylCode, this.qrToken = '', this.holdUntil, final  Map<String, dynamic> categoryData = const <String, dynamic>{}, this.groupId, this.createdAt, this.updatedAt}): _categoryData = categoryData;
...
@JsonKey(includeFromJson: false, includeToJson: false)
@override
int get hashCode => Object.hashAll([runtimeType,id,userId,merchantId,placeId,eventId,category,status,startsAt,endsAt,amountIqd,paymentId,paymentStatus,paymentMethod,waylCode,qrToken,holdUntil,const DeepCollectionEquality().hash(_categoryData),groupId,createdAt,updatedAt]);
