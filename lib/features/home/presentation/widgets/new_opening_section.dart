...
class NewOpeningSection extends ConsumerStatefulWidget {
  const NewOpeningSection({super.key, this.onViewAll});

  final VoidCallback? onViewAll;

  @override
  ConsumerState<NewOpeningSection> createState() => _NewOpeningSectionState();
}

class _NewOpeningSectionState extends ConsumerState<NewOpeningSection> {
