...
import 'package:future_riverpod/core/constants/theme/theme_provider.dart' hide AppTheme;
...
class MyApp extends ConsumerWidget {
  ...
  Widget build(BuildContext context, WidgetRef ref) {
    ...
    return MaterialApp.router(
      ...
      darkTheme: AppTheme.darkTheme(languageCode: languageCode, context: context),
