...
export const dict = {
  ar: {
    ...
    "ben.b3.body": "تحكم بأوقات الدوام، دير الخصومات، وشوف كل معاملات اماكنك من لوحة وحدة.",
    ...
    "join.s2.body": "صور، اوقات الدوام وموقع على الخريطة.",
    ...
    "hero.sub": "مطاعم، ملاعب، مزارع وحفلات، كلها بتطبيق واحد. شوف، احجز، وادفعبالبطاقة، وتذكرتك تجيك QR.",
    ...
    "what.c2.body": "احجز طاولة، ملعب، شاليه او تذكرة حفلة وانت كاعد وادفع بالبطاقة.",
    ...
    "how.s3.body": "ادفعبالبطاقة وتذكرتك تجيك QR.",
  ...
  en: {
    ...
    "what.c2.body": "Book a table, a court, a chalet or a concert ticket from your seat and pay in IQD.",
    ...
    "band.title": "Own a farm or a court?",
