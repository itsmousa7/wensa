...
export const dict = {
  ar: {
    ...
    "ben.b3.title": "فلوسك بالدينار",
    "ben.b3.body": "الدفع بالدينار العراقي وتحويل لحسابك البنكي.",
    ...
    "join.s2.body": "صور، دوام، وموقع على الخريطة.",
    ...
    "plan.basic.f": "٢ أماكن + فعاليات مجمعة · ٣ صور إضافية · قائمة أساسية · لا إعلانات مجانية (٥٬٠٠٠ د.ع لكل إعلان)",
    ...
    "faq.q1": "شكد العمولة؟",
    "faq.a1": "[PENDING] العمولة تنحدد حسب الاتفاق — تواصل ويانا.",
    "faq.q2": "امتى توصلني فلوسي؟",
    "faq.a2": "[PENDING] التحويل يوصل لحسابك البنكي حسب دورة الدفع.",
    "faq.q3": "اكو عقد لازم اوقعه؟",
    "faq.a3": "[PENDING] تكدر تبدي بدون عقد طويل.",
    "faq.q4": "عندي كم مكان — كلهم بحساب واحد؟",
    "faq.a4": "[PENDING] اي، تكدر تدير كل اماكنك من حساب واحد.",
  ...
  en: {
    ...
    "ben.b3.title": "Paid in IQD",
    "ben.b3.body": "Payment in Iraqi dinar, transferred to your bank account.",
    ...
    "plan.basic.f": "2 combined places & events · 3 additional photos · Basic listing · No free banners (5,000 IQD each)",
    ...
    "faq.a1": "[PENDING] Commission is set per agreement — get in touch.",
    "faq.q2": "When do I get paid?",
    "faq.a2": "[PENDING] Transfers reach your bank account on the payout cycle.",
    "faq.q3": "Do I need to sign a contract?",
    "faq.a3": "[PENDING] You can start without a long-term contract.",
    "faq.q4": "I have several venues — one account?",
    "faq.a4": "[PENDING] Yes, you can manage all your venues from one account.",
